...
from eduWeb.models import Lesson, Course
from flask import (
    render_template,
    url_for,
    flash,
...
from eduWeb.lessons.forms import (
    NewLessonForm,
    LessonUpdateForm,
)
from eduWeb.courses.forms import NewCourseForm
...
from eduWeb.helpers import save_picture
from eduWeb.lessons.helpers import get_previous_next_lesson, delete_picture
